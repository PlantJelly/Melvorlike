...
export const ResourceDB: Record<string, ResourceDef> = Object.fromEntries([
    ...
    row('blacksmith_meal', '대장장이 정식', 'cooking', 25, 9000, 140, 9621, '🍽️', {egg: 2, potato: 1, milk: 1}),
    row('festival_dish', '축제 요리', 'cooking', 40, 12000, 220, 9814, '🎉', {potato: 1, carrot: 1, egg: 1, milk: 1, grilled_fish: 1}),
    ...
    row('enchant_stone_stone', '스톤급 마법부여석', 'magic', 1, 10000, 50, 444, '🔮', {chamomile: 2, mana_stone: 1}),
